...
import io.github.jiefenn8.graphloom.rdf.r2rml.*;
...
public class R2RMLBuilder {
    ...
    private Pair<PredicateMap, NodeMap> buildPredicateObjectMap(Statement triple) {
        ...
        PredicateMap predicateMap = buildTermMap(predicateMapTriple, R2RMLFactory::createPredicateMap, TermMap.TermType.IRI);
        ...
        ObjectMap objectMap = buildTermMap(objectMapTriple, R2RMLFactory::createObjectMap, TermMap.TermType.LITERAL);
     ...
     */
    private <R> R buildTermMap(Statement triple, Function<TermMap, ? extends R> action, TermMap.TermType termType) {
     ...
     * @return instance of TermMap with mapped values
     */
    private TermMap buildTemplateTermMap(Resource subject, TermMap.TermType termType) {
     ...
     * @return instance of TermMap with mapped values
     */
    private TermMap buildColumnTermMap(Resource subject, TermMap.TermType termType) {
